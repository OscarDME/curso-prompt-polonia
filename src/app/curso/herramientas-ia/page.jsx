// src/app/curso/herramientas-ia/page.jsx
"use client";
...
import { iaToolsContent } from "@/lib/ia-tools-content";
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div className="space-y-1">
            ...
            <p className="max-w-2xl text-xs md:text-sm text-slate-300">
              To narzędzia pomyślane tak, aby łączyć je z Twoim Sekretnym Bankiem
              Promptów. Nie musisz używać wszystkich: zacznij od 1–3 i rozszerzaj
              dopiero wtedy, gdy Twój system będzie tego potrzebował.
            </p>
          </div>
