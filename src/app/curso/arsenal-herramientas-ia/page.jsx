        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div className="space-y-1">
            ...
            <p className="max-w-2xl text-xs md:text-sm text-slate-300">
              Usa este arsenal como un catálogo vivo. Empieza por las
              categorías que más impacto tengan en tu día a día y ve
              incorporando nuevas herramientas solo cuando tu sistema lo
              necesite.
            </p>
          </div>
